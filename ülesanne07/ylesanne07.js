// Mathias Möll
// Kuupäev: 28.01.2026
// Ülesanne 7: for-tsüklid


//1️ Tooted
const tooted = [
    "Õunad", "Piim", "Leib", "Juust", "Tomatid",
    "Kanafilee", "Muna", "Sibul", "Apelsinid", "Riis",
    "Jogurt", "Kartul", "Kalafilee", "Pasta", "Jogurtijook",
    "Porgandid", "Virsikud", "Pähklid", "Rosinad", "Kapsas",
    "Kreeka jogurt", "Veiseliha", "Banaanid", "Oliivid",
...
let maxTemp = temp[0][0];
let minTemp = temp[0][0];
let maxMonth = "";
let minMonth = "";
...
for (let i = 0; i < temp.length; i++) {
    ...
    let avg = sum / temp[i].length;
    console.log(months[i] + " keskmine temp:", avg.toFixed(1)); }

console.log("kõrgeim temp oli", maxTemp, "kraadi kuus", maxMonth);
console.log("madalaim temp oli", minTemp, "kraadi kuus", minMonth);
